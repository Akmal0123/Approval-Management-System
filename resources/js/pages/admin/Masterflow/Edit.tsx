...
interface MasterflowStep {
    ...
    is_required: boolean;
    jabatan_id: number;
    min_nominal?: string | number | null;
    jabatan?: Jabatan;
}
...
export default function Edit({ masterflow, jabatans, company, transaksis = [] }: Props) {
    const [formData, setFormData] = useState({
        name: masterflow.name,
        transaksi_id: masterflow.transaksi_id ? masterflow.transaksi_id.toString() : '',
        ...
        steps: masterflow.steps.map((step) => ({
            ...
            min_nominal: step.min_nominal ? String(step.min_nominal) : '',
        })),
    });
